...
\emph{fragmentation}~\cite{Osterlund:FPP}~\cite{Iyengar:Collie}~\cite{Tene:C4}. Fragmentation is the forming
...
of instructions that are part of a process the thread belongs to. A process
can involve a single thread, or a process can involve multiple threads.
