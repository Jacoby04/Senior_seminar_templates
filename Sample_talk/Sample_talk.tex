...
\frametitle{The Continuously Concurrent Compacting Collector (C4)}
...
Read barrier protecting from-space from application threads

\linespace
\linespace

Can only use moved objects
...
\begin{itemize}
\item Application threads bound to trigger LVB
\end{itemize}
...
\emph{lazy remapping}: application threads update references as they trigger LVB
\begin{itemize}
\item "If the object was moved, find it"
...
To ensure all references are updated, need to traverse all reachable ones
