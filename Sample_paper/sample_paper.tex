...
Each object in an application's memory has a \emph{referrer set}. This set
identifies the precise set of all references pointing to the object. 
...
\todo[inline]{Might need to add more background. Wait to see how discussing the algorithm goes.}
