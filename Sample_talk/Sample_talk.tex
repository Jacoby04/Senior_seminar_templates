...
\begin{column}{0.45\textwidth}
	...
	\only<2->{\item \color{black}{! = Impeded}} 
	\only<3->{\item * = Responsible}
	\end{itemize}
\end{column}
\begin{column}{0.55\textwidth}
	\only<1>{\includegraphics[width=.95\textwidth]{Illustrations/coffeeLine1.png}}
	\only<2>{\includegraphics[width=.95\textwidth]{Illustrations/coffeeLine2.png}}
	\only<3>{\includegraphics[width=.95\textwidth]{Illustrations/coffeeLine3.png}}
	\only<4>{\includegraphics[width=.95\textwidth]{Illustrations/coffeeLine4.png}}
	\only<5>{\includegraphics[width=.95\textwidth]{Illustrations/coffeeLine5.png}}
\end{column}
\end{columns}
