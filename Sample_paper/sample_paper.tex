...
pausing the application in order to clean up. With storage media growing, 
...
different techniques which are all implemented and tested within different
garbage collectors.
