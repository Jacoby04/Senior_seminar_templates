...
conflicts, the checks performed result in extra processing overhead for threads.
...
compare them to one another. Direct comparisons are especially difficult since the
