...
%Remember to emphasize the key point is interruptions will cause noting to happen, or everything to.
\only<1>{
...
\begin{center}
Figure out how to show it later
\end{center}
...
Relocation + remapping $\rightarrow$ transaction
}
