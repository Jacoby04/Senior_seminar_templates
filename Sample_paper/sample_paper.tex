...
it is not discussed here. The other invariant effectively states that a loaded
reference value must point to the location of the object that currently has the
object's contents that are safely accessible. If the invariant does not hold
