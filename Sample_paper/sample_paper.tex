...
The key point to understand here is GC threads do the most work. They simply
...
points to will be checked for if it has been relocated; if it has not been, the
...
a compare and swap operation is performed to change the original location
