...
The key component driving FPP is the \emph{hazard pointer} (HP). HPs
...
is pinned by a mutator, it cannot be relocated. Once all threads have
...
While it is explained in more detail below, an example of how hazard pointers 
...
\subsection{The Blame Game}
\label{sec:fppBlame}

things

\subsection{Copy Racing}
\label{sec:fppCopy}
...
it does not require special hardware or operating system requirements.
