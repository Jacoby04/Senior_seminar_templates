...
A process can involve a single thread or multiple threads.  In JVM languages,
...
of avoiding stop-the-world pauses in garbage collectors. Additionally, compacting
...
ensures all of the object's references
