...
computers to perform certain tasks. One way in which programming
...
space in memory for objects and certain variables. On the other hand,
managed languages tend to have automatic memory management provided for them through 
the use of a \emph{virtual machine}. For our purposes, a virtual machine can be thought
...
in this paper are implemented on the Java Virtual Machine (JVM), which is a virtual machine
